    ...
    <View style={styles.container}>
      <View style={styles.containerBackground}>
        ...
        <View style={styles.containerBox}>
          <View style={{ width: '90%', marginTop: 20, display: 'flex', gap: 20 }}>
            <Text style={{ color: '#000', fontSize: 16, fontWeight: '500', alignSelf: 'center' }}>Enter mobile number and password</Text>
            <View style={styles.inputView}>
              <TextInput placeholder='Mobile Number' placeholderTextColor="gray" onChangeText={setmobile_no} keyboardType="numeric" maxLength={10} style={[styles.inputText, mobileError ? { borderColor: '#ff0000', borderWidth: 2 } : {}]} value={mobile_no} />
              {mobileError && <Text style={styles.error}>{mobileError}</Text>}
            </View>
            <View style={styles.inputView}>
              <TextInput placeholder='Password' placeholderTextColor="gray" onChangeText={setPassword} style={[styles.inputText, passwordError ? { borderColor: '#ff0000', borderWidth: 2 } : {}]}
